...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43683779035178427)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43684064213178427)
,p_plug_template_id=>wwv_flow_api.id(43683779035178427)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43684390450178427)
,p_plug_template_id=>wwv_flow_api.id(43683779035178427)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43684610233178427)
,p_plug_template_id=>wwv_flow_api.id(43683779035178427)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43684986881178428)
,p_plug_template_id=>wwv_flow_api.id(43683779035178427)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43685292416178428)
,p_plug_template_id=>wwv_flow_api.id(43683779035178427)
