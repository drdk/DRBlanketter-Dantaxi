...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43676306651178424)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43676676077178425)
,p_plug_template_id=>wwv_flow_api.id(43676306651178424)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43676906353178425)
,p_plug_template_id=>wwv_flow_api.id(43676306651178424)
,p_name=>'Tabs'
