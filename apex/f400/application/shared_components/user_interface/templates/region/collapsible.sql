...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43630219669178405)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43630532506178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43630808753178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43631172099178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43631419763178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43631730524178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43632062503178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43632339477178405)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43632657317178406)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43632938316178406)
,p_plug_template_id=>wwv_flow_api.id(43630219669178405)
,p_name=>'Sub Regions'
