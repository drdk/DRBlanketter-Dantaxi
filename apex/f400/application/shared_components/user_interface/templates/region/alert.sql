...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43616317159178396)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43616676916178399)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43616924014178399)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43617219228178399)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43617587739178399)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43617856746178399)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43618185250178400)
,p_plug_template_id=>wwv_flow_api.id(43616317159178396)
,p_name=>'Sub Regions'
