...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43664176993178419)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43664439524178420)
,p_plug_template_id=>wwv_flow_api.id(43664176993178419)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43664789502178420)
,p_plug_template_id=>wwv_flow_api.id(43664176993178419)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43665031900178420)
,p_plug_template_id=>wwv_flow_api.id(43664176993178419)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43665368936178420)
,p_plug_template_id=>wwv_flow_api.id(43664176993178419)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43665682569178420)
,p_plug_template_id=>wwv_flow_api.id(43664176993178419)
,p_name=>'Sub Regions'
