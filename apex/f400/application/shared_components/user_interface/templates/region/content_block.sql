...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43640332528178410)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43640638372178410)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43640918750178410)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43641277380178410)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43641502731178411)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43641848360178411)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43642102091178411)
,p_plug_template_id=>wwv_flow_api.id(43640332528178410)
,p_name=>'Sub Regions'
