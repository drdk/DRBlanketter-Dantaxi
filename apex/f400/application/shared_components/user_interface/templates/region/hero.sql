...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43644524263178412)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43644815142178412)
,p_plug_template_id=>wwv_flow_api.id(43644524263178412)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43645165467178412)
,p_plug_template_id=>wwv_flow_api.id(43644524263178412)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43645432041178412)
,p_plug_template_id=>wwv_flow_api.id(43644524263178412)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43645773834178413)
,p_plug_template_id=>wwv_flow_api.id(43644524263178412)
,p_name=>'Sub Regions'
