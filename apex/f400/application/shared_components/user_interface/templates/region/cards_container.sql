...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43628670649178404)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43628918919178404)
,p_plug_template_id=>wwv_flow_api.id(43628670649178404)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43629212905178404)
,p_plug_template_id=>wwv_flow_api.id(43628670649178404)
,p_name=>'Sub Regions'
