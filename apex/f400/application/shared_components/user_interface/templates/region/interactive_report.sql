...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43662347585178419)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43662635808178419)
,p_plug_template_id=>wwv_flow_api.id(43662347585178419)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43662934335178419)
,p_plug_template_id=>wwv_flow_api.id(43662347585178419)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43663266293178419)
,p_plug_template_id=>wwv_flow_api.id(43662347585178419)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43663504511178419)
,p_plug_template_id=>wwv_flow_api.id(43662347585178419)
,p_name=>'Sub Regions'
