...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43652384437178415)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43652673109178415)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43652929412178415)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43653276795178415)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43653559576178415)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43653862208178415)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43654126697178416)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43654406264178416)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(43654707685178416)
,p_plug_template_id=>wwv_flow_api.id(43652384437178415)
,p_name=>'Sub Regions'
